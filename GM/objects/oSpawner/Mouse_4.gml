...
if (global.part_with_text){
	...
	switch(global.id_replique){
		...
		case 9 : global.bob_transition1.dos = false;
		dialog_text = "Bob : Hey ! Hello you ! How long have you been here? I didn’t see you. Are you here to teach me some algorithms ?"; text_or_not = true; break;
		...
		case 12 : 
			...
			text_or_not = true; 
			wendy = instance_create_depth(1250, 355, 0, oWendy);
			with (wendy) {
				image_xscale = 0.39;
				image_yscale = 0.39;
			}
		...
		//Room5 : tuto W.S. + Room6 : Bob (WS) vs User
			
		//Room7 : transition2 vers le monde système expert
